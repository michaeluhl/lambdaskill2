...
class SayAsInterpretations(StrEnum):
    ADDRESS = 'address'
    CARDINAL = 'cardinal'
...
class AmazonEffect(Element):
    ...
    def __init__(self, name=AmazonEffects.WHISPERED, children=None):
        name = AmazonEffects(name)
...
class Break(Element):
    ...
    def __init__(self, strength=None, time=None):
        ...
        if strength:
            strength = BreakStrength(strength)
...
class Phoneme(Element):
    ...
    def __init__(self, ph, alphabet=PhonemeAlphabet.X_SAMPA, children=None):
...
class SayAs(Element):
    ...
    def __init__(self, interpret_as, format=None, children=None):
        interpret_as = SayAsInterpretations(interpret_as)
...
class SSML(object):
    ...
    def amazon_effect(self, name=AmazonEffects.WHISPERED, children=None):
    ...
    def phoneme(self, text, ph, alphabet=PhonemeAlphabet.X_SAMPA):
